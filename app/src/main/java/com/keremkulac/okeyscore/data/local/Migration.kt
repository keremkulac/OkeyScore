...
open class Migration : Migration(1, 2) {

    override fun migrate(db: SupportSQLiteDatabase) {
        if (db.version < 2) {
            db.execSQL(
                "CREATE TABLE temp_finishedPartnerGame (" +
            ...
            db.execSQL(
                "CREATE TABLE finishedPartnerGame (" +
                        "id INTEGER PRIMARY KEY NOT NULL, " +
                        "team1id INTEGER, " +
                        "team1name TEXT, " +
                        "team1allScores TEXT, " +
            ...
            db.execSQL(
                "CREATE TABLE temp_finishedSingleGame (" +
                        "id INTEGER PRIMARY KEY NOT NULL, " +
                        "player1id INTEGER, " +
                        "player1name TEXT, " +
            ...
            db.execSQL(
                "CREATE TABLE finishedSingleGame (" +
                        "id INTEGER PRIMARY KEY NOT NULL, " +
                        "player1id INTEGER, " +
                        "player1name TEXT, " +
                        "player1allScores TEXT, " +
