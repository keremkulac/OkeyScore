...
@Inject constructor(private val okeyScoreRepositoryImp: OkeyScoreRepositoryImp) : ViewModel() {
   ...
   private fun getFinishedGames(){
        viewModelScope.launch {
            _allFinishedGamesPartnerGame.postValue(ArrayList(okeyScoreRepositoryImp.getAllFinishedPartnerGames()))
        }
    }
    ...
    fun deleteFinishedGame(finishedPartnerGame: FinishedPartnerGame){
        viewModelScope.launch {
            okeyScoreRepositoryImp.deleteFinishedPartnerGame(finishedPartnerGame)
        }
    }
